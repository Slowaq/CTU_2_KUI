...
class ReversiCreator(object):
    ...
    def __init__(self, player_array):
        ...
        self.player1 = player_creator.create_player(
            players[0], self.player1_color, self.player2_color, BOARD_SIZE
        )
        self.player2 = player_creator.create_player(
            players[-1], self.player2_color, self.player1_color, BOARD_SIZE
        )
        self.board = GameBoard(board_size=BOARD_SIZE)
        self.sleep_time_ms = 200
        self.gui = ReversiView(players=player_array, board_size=BOARD_SIZE)
